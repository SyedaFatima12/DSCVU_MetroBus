...
public class PaymentActivity extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID      = "MC18674";
    private final String Jazz_Password        = "8wwvaxd9zt";
    private final String Jazz_IntegritySalt   = "zu088s19f8";
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(com.example.metrobus.PaymentActivity.this, Home.class);
